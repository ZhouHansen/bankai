...
var babelSplitRequire = require('babel-plugin-dynamic-import-split-require')
var babelObjectSpread = require('babel-plugin-transform-object-rest-spread')
...
function node (state, createEdge) {
  ...
  b.transform(tfilter(babelify, { exclude: /node_modules/ }), {
    babelrc: true,
    plugins: [babelSplitRequire, babelObjectSpread],
    presets: [
      [babelPresetEnv, {
